...
function Navigation(){
  return (
    <header className="bg-dark-azure flex flex-wrap md:flex-nowrap justify-end items-e px-5 py-4 z-50">
      <div id="logo_section" className="me-5 flex-2 flex flex-row items-center ">
      ...
      <div id="links" className="flex flex-wrap flex-8 md:items-center lg:justify-end-safe text-white text-sm md:text-xl font-light md:mt-0">
